...
@section('content')
            ...
            <div class="box1">
                <div class="box">
                  <div class="form">
                    <form action="{{ route('majordashboard.update-major', $major->id) }}" method="post" onsubmit=" validateMajor()">
                      @csrf
                      @method('PUT')
                    <h3>Add University</h3>
                    <div class="input-box">
                      <input type="text" id="name-major" name="name-major" value="{{ $major->name }}" required="required" />
